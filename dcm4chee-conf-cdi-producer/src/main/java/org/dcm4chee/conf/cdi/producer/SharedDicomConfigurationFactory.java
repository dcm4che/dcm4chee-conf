...
public class SharedDicomConfigurationFactory implements DicomConfigurationManagerFactory {
    ...
    @Inject
    private CdiConfigExtensionsLookup configExtensionManager;
    
    @Override
    public DicomConfigurationManager createDicomConfigurationManager() throws ConfigurationException {
        configExtensionManager.registerCdiConfigExtensions(builder);
