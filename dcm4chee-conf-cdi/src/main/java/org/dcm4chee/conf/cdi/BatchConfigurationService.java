...
/**
 * Service to ensure batched configuration changes are executed within a transaction.
 * 
...
public interface BatchConfigurationService {
    ...
    /**
     * Runs a configuration batch change on the given configuration.
     * 
     * The method implementation must ensure that the changes are executed within a transaction.
