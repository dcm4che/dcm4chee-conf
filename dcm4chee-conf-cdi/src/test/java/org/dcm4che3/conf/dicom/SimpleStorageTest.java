...
import org.dcm4che.kiwiyard.core.storage.SimpleCachingConfigurationDecorator;
...
public class SimpleStorageTest
{
    ...
    public static CommonDicomConfigurationWithHL7 createCommonDicomConfiguration( Map<Class, List<Class>> extensionsByBaseClass ) throws ConfigurationException
    {
        ...
        extensionsByBaseClass.entrySet()
                .forEach( ( entry ) -> entry.getValue()
                        .forEach( ( extClass ) -> builder.registerExtensionForBaseExtension( entry.getKey(), extClass ) )
                );
    ...
    public void testSave() throws ConfigurationException
    {
        ...
        boolean equals = DeepEquals.deepEquals( p3, xCfg.getConfigurationNode( Path.ROOT, null ) );
        Assert.assertTrue( "Stored config node must be equal to the one loaded", equals );
        ...
        boolean searchWorks = DeepEquals.deepEquals( o, p1 );
        Assert.assertTrue( "Search should work. ", searchWorks );
    }
