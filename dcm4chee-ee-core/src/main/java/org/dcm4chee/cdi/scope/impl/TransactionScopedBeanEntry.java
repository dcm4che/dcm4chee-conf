 ...
 *
 */
public class TransactionScopedBeanEntry<T> {
    private final Contextual<T> bean;
    private final T contextualInstance;
    private final CreationalContext<T> creationalContext;

    public TransactionScopedBeanEntry(Contextual<T> bean, T contextualInstance, CreationalContext<T> creationalContext) {
        this.bean = bean;
