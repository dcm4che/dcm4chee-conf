...
public class DependentScopedHooksTest {
    ...
    public static JavaArchive createDeployment() {
        return ShrinkWrap
                ...
                .addClass(ServiceWithDependentScopedHooks.class)
                .addClass(DepScopedHook.class)
                .addAsManifestResource(EmptyAsset.INSTANCE, "beans.xml");
    }
    
    @Inject
    private ServiceWithDependentScopedHooks hookedServiceB;   
    
    @Before
    public void before() throws URISyntaxException {
        URL hooksConfigURL = this.getClass().getClassLoader().getResource("dep-scoped-hook-config.json");
